...
<section class="block">
  <h2>Call or Text Today for a Free Hardwood Flooring Evaluation Anywhere in San Diego County</h2>
  <div class="info-grid">
    <div class="card">
      <h3>Call or Text</h3>
    ...
    <div class="card">
      <h3>Response Time</h3>
      <p>We typically respond the same day to calls, texts, emails, and estimate requests throughout San Diego County.</p>
    </div>
  </div>
