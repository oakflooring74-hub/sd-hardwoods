...
ALT_OVERRIDE = {
    ...
    "/DOUGLAS FIR REFINISHING16.jpg": "After #10 in Golden Hill near South Park and Bankers Hill: the same Douglas Fir floor fully restored, stained in a rich Jacobean color and sealed with a satin commercial-grade finish, leaving a spotless, durable restoration that proves the effectiveness of true dust-free sanding.",
    ...
    "/FRENCH OAK INSTALL21.jpg": "Before #12 in this Bankers Hill commercial space near South Park and Mission Valley: wide-plank, seven-inch random-length engineered French oak shown raw, installed but not yet sanded, ahead of professional dust-free sanding and site finishing.",
    "/FRENCH OAK INSTALL60.jpg": "After #12 in this Bankers Hill commercial space near South Park and Mission Valley: the same wide-plank engineered French oak floor sanded flat and finished on site with the same durable commercial finish and natural tone used in the first phase, creating a smooth, modern wide-plank floor built to withstand heavy restaurant use.",
